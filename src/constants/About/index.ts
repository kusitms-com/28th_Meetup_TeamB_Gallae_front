...
export const GALLAE_INTRODUCTION: GallaeIntroduction = {
  ...
  value: {
    ...
    content: [
      ...
      '',
      '‘갈래’에서는 다양한 여행지원사업, 여행 대외활동, 여행 공모전 등 <b style="font-family: SUIT-ExtraBold; color: #53575C">여행 경비를 절감할 수 있는 정보</b>를<br/>아카이빙 하여 제공합니다. 정보 제공과 더불어 <b style="font-family: SUIT-ExtraBold; color: #53575C">색다른 여행지 탐색 및 공유</b>도 가능합니다.',
      '',
